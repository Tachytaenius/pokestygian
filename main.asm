...
.PokedexStringSecondary	 db "Look@"
.PartyStringSecondary	   db "Use@"
.PackStringSecondary	    db "Take@"
.StatusStringSecondary	  db "Talk@"
.SaveStringSecondary	    db "Attack@"
.OptionStringSecondary	  db "Touch@"
.ExitStringSecondary	    db "Cancel@"
.PokegearStringSecondary	db "Ingest@"
.QuitStringSecondary	    db "ERROR@"
...
; Hey! wolfboyft! Over here! Put your GFX over here!
;items
NotePic::
INCBIN "gfx/stygian/note.2bpp"
GelPic::
INCBIN "gfx/stygian/gel.2bpp"
BallPic::
INCBIN "gfx/stygian/ball.2bpp"
BookPic::
INCBIN "gfx/stygian/book.2bpp"
PokePic::
INCBIN "gfx/stygian/poke.2bpp"
ButtonPic::
INCBIN "gfx/stygian/button.2bpp"
BoulderPic::
INCBIN "gfx/stygian/boulder.2bpp"
BagPic::
INCBIN "gfx/stygian/bag.2bpp"
BannerPic::
